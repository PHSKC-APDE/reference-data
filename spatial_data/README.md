...
* **[county_codes.csv](https://github.com/PHSKC-APDE/reference-data/blob/main/spatial_data/county_codes.csv)** = Mapping of WA county names to various identifying codes (FIPS = Federal Information Processing Standard, GNIS = Geographic Name Information System, TIGER = Topologically Integrated Geographic Encoding & Referencing, AFF = American Fact Finder)
