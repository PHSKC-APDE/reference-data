...
The complete commit history for these files is visible in GitHub Bash and GitHub Desktop. Unforunately, GitHub online does not display commits prior to renaming the folder. You can view a synopsis of these commits [online](https://github.com/PHSKC-APDE/reference-data/commit/d86c4ccaa6b02c41e2f06cb485d9efa11cb73ec4). Individual commits (identified from your log) can also be viewed online. 
